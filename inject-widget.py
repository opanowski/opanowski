...
<style>
  ...
  #omopan-window{position:fixed;bottom:92px;left:24px;width:320px;height:420px;background:#fff;border-radius:16px;box-shadow:0 8px 32px rgba(0,0,0,0.18);display:flex;flex-direction:column;overflow:hidden;z-index:9998;font-family:sans-serif;transition:opacity 0.2s,transform 0.2s;}
